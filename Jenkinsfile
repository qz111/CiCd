pipeline {
    ...
    stages {
        ...
        stage('deploy over ssh') {
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'hostfordeploy', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: '''sudo docker pull kloseqz/cicdjenkins:v1.0
